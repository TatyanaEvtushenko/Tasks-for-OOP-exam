...
{
    //Разработать контейнер «динамический массив» — List, который
    ...
    //- предоставляет типовые процедуры, применяемые при работе с массивом(вставка по индексу, удаление по индексу, 
    //очистка, копирование в другой массив, поиск индекса элемента по ссылке, сортировка), +
    ...
    class List : IList<object>
    {
        ...
        public List(int countOfReservedElements = 1)
        {
            ...
            _items = new object[countOfReservedElements];
        }
        ...
        public void CopyTo(List otherList)
        {
            otherList.Clear();
        ...
        public void Sort()
        {
            Array.Sort(_items, 0, Count, new ObjectComparer());
        }

        private IEnumerable<object> GetCorrectItems()
        {
